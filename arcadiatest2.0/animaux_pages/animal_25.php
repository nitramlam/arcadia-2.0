...
<head>
    <meta charset='UTF-8'>
    <title>animal - Page Personnalisée</title>
    <link rel='stylesheet' href='animauxPage.css'>
</head>
<body>
    <div class="animal-main">
        <h1 class="animal-title">animal</h1>
        <img class="animal-photo" src="/animaux/Capture d’écran 2024-10-16 à 12.45.29.png" alt="animal">
        <div class="info-section">
            <h2>Informations Générales</h2>
            <div class="general-info">
                <p class="species-info"><strong>Espèce:</strong> 0</p>
                <p class="description-info"><strong>Description:</strong> animal</p>
